...
exports.adminConsoleService = exports.AdminConsoleService = void 0;
...
class AdminConsoleService {
     ...
     */
    async getRealtimeMetrics(adminId) {
        try {
            // Verify admin permissions
            const admin = await prisma.user.findUnique({
                where: { id: adminId },
     ...
     * Get system alerts
     */
    async getAlerts(adminId, options = {}) {
        try {
            // Verify admin permissions
            const admin = await prisma.user.findUnique({
                where: { id: adminId },
     ...
     * Resolve an alert
     */
    async resolveAlert(adminId, alertId) {
        try {
            // Verify admin permissions
            const admin = await prisma.user.findUnique({
                where: { id: adminId },
     ...
     */
    async getModerationQueue(adminId, options = {}) {
        try {
            // Verify admin permissions
            const admin = await prisma.user.findUnique({
                where: { id: adminId },
     ...
     */
    async processModerationItem(adminId, itemId, action, reason) {
        try {
            // Verify admin permissions
            const admin = await prisma.user.findUnique({
                where: { id: adminId },
     ...
     * Ban/unban user
     */
    async banUser(adminId, userId, reason, duration) {
        try {
            // Verify admin permissions
            const admin = await prisma.user.findUnique({
                where: { id: adminId },
     ...
     * Log admin action
     */
    async logAdminAction(adminId, action, resource, changes, metadata) {
        try {
     ...
     */
    async updateSystemConfig(adminId, config) {
        try {
            // Verify admin permissions
            const admin = await prisma.user.findUnique({
                where: { id: adminId },
...
exports.adminConsoleService = new AdminConsoleService();
