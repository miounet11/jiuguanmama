...
class GuidanceService {
     ...
     * 应用指导到消息生成
     */
    applyGuidanceToMessages(messages, guidancePrompt) {
...
请严格按照以上指导生成回复。`
     ...
     * 保存指导历史
     */
    async saveGuidanceHistory(sessionId, messageId, guidance) {
...
exports.guidanceService = new GuidanceService();
