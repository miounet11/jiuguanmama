...
CREATE TABLE "Character" (
    ...
    "mbti_traits" TEXT NOT NULL DEFAULT '[]',
    "mbti_compatibility" TEXT NOT NULL DEFAULT '[]',
    "mbti_weaknesses" TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE "Message" (
    ...
    "metadata" TEXT,
    "spacetime_events" TEXT NOT NULL DEFAULT '[]',
    "relation_triggers" TEXT NOT NULL DEFAULT '[]',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
...
CREATE TABLE "Scenario" (
    ...
    "language" TEXT NOT NULL DEFAULT 'zh-CN',
    "spacetime_hub_enabled" BOOLEAN NOT NULL DEFAULT false,
    "spacetime_attributes" TEXT NOT NULL DEFAULT '[]',
    "spacetime_layout" TEXT,
    "fusion_mechanisms" TEXT,
    "plot_phases" TEXT,
    "genre" TEXT,
    "complexity" TEXT,
    "content_rating" TEXT,
...
CREATE TABLE "WorldInfoEntry" (
    ...
    "plot_phases" TEXT NOT NULL DEFAULT '[]',
    "dynamic_weight" TEXT NOT NULL DEFAULT '{}',
...
CREATE TABLE "CharacterRelation" (
    ...
    "description" TEXT NOT NULL,
    "interaction_triggers" TEXT NOT NULL DEFAULT '[]',
    "compatibility_score" REAL,
    "importance" INTEGER NOT NULL DEFAULT 1,
    "is_active" BOOLEAN NOT NULL DEFAULT true,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "CharacterRelation_from_character_id_fkey" FOREIGN KEY ("from_character_id") REFERENCES "Character" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "CharacterRelation_to_character_id_fkey" FOREIGN KEY ("to_character_id") REFERENCES "Character" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "CharacterRelation_from_character_id_idx" ON "CharacterRelation"("from_character_id");

-- CreateIndex
CREATE INDEX "CharacterRelation_to_character_id_idx" ON "CharacterRelation"("to_character_id");

-- CreateIndex
CREATE INDEX "CharacterRelation_relation_type_idx" ON "CharacterRelation"("relation_type");

-- CreateIndex
CREATE INDEX "CharacterRelation_is_active_idx" ON "CharacterRelation"("is_active");

-- CreateIndex
CREATE UNIQUE INDEX "CharacterRelation_from_character_id_to_character_id_relation_type_key" ON "CharacterRelation"("from_character_id", "to_character_id", "relation_type");
