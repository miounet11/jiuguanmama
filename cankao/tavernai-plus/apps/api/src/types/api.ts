...
export interface ApiUser {
  id: string
  username: string
  email?: string  // 仅对自己或管理员可见
  avatar: string | null
  bio: string | null
  role: string
  credits?: number  // 仅对自己或管理员可见
  subscriptionTier?: string  // 仅对自己或管理员可见
  isActive: boolean
  isVerified: boolean
...
export interface MessageListQuery {
  ...
  sessionId?: string
  roomId?: string
  before?: string  // 获取某个消息之前的消息
  after?: string   // 获取某个消息之后的消息
}
